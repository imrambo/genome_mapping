...
env.SConscript('mapping/SConscript', exports='env', build_dir=env['OUTDIR'], duplicate=0)
env.SConscript('network/SConscript', exports='env', build_dir=env['OUTDIR'], duplicate=0)
