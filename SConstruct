...
env.SConscript('mapping/SConscript', exports='env', variant_dir=env['OUTDIR'], duplicate=0)
env.SConscript('network/SConscript', exports='env', variant_dir=env['OUTDIR'], duplicate=0)
